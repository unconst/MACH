...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        help=
        'Target learning rate, applied to the logit softmax. Default learning_rate=1e-4'
    )
    parser.add_argument(
        '--l_learning_rate',
        default=1e-5,
        type=float,
        help=
        'Local model learning rate, Applied to internal embedding. Default learning_rate=1e-4'
    )
    parser.add_argument(
        '--n_embedding',
        default=128,
